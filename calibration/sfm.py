...
img_path = '/home/null9/sub_hdd/githubCode/easynerf/data/boo_pancilcase/'
img1_name = 'boo_10.jpg'
img2_name = 'boo_11.jpg'
...
def initialize_CM(CM):
    ...
    skew = 0.0215878
    K = np.array([[673.66075255, skew, 377.31863526], [0, 674.09584542, 494.7480263], [0, 0, 1]])
    Rt1 = K @ CameraMatrix
    return Rt0, Rt1
